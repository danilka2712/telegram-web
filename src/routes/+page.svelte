                        ...
                        >
                            ...
                            {#if product.quantity === 0}
                                <button
                                    ...
                                    class="mt-3 bg-[#0ea5e9] uppercase font-semibold p-2 w-3/4 rounded-lg text-sm"
                                    >Купить</button
                                >
                            {:else}
                                <div class="flex w-full gap-2 justify-center">
                                    <button
                                        ...
                                        class="mt-3 bg-red-500 flex items-center justify-center uppercase font-semibold w-2/6 rounded-lg text-sm"
                                        ><Minus /></button
                                    >
                                    <button
                                        on:click={() =>
                                            toggleMainButton(product)}
                                        class="mt-3 bg-[#0ea5e9] uppercase flex items-center justify-center font-semibold w-2/6 rounded-lg text-sm"
                                        ><Plus /></button
                                    >
                                </div>
                            {/if}
